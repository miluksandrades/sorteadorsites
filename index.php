    ...
    <body>
        <div class="container-fluid"style="text-align: center">
            ...
            <div class="container-fluid col-md-4 col-sm-8 col-xl-2 bg-success justify-content-center" style="border-radius: 5px; text-align: center;">
                ...
                <p class="lead text-white" id="numeroSorteado"  style="font-size: 90px"><b>GO</b><i class="fa fa-arrow-down"></i></p>
            </div>
        ...
        <script>
            function gerar(){
                ...
                var numeroSorteado = Math.floor(Math.random(numeros)*290+1);
